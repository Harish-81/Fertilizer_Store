...
const Home = () => {
  ...
  const fetchStoreProducts = async () => {
    try {
      const response = await axios.get("https://fertilizer-store-backend.onrender.com/api/products");
  ...
  return (
    <div
      ...
      <Carousel
        ...
        showStatus={false}
        interval={3000}
        style={{ maxWidth: "800px", margin: "0 auto" ,boxShadow:"4px 4px 10px 0 rgba(0, 0, 0, 0.2)"}}>
      ...
      <div
        ...
        <p
          ...
          Example: Search for a Fertilizer or other agricultural product 🛒 and get
          recommendations!
        </p>
        <input
          type='text'
